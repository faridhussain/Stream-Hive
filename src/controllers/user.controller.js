...
// controller responsible for updating the logged-in user's cover image
const updateUserCoverImage = asyncHandler(async (req, res) => {
    // get the path of the uploaded cover image
    // multer stores the uploaded file temporarily on the local server
    ...
    // store the cloudinary url instead of the local file path
    const user = await User.findByIdAndUpdate(
        req.user?._id,
        {
            $set: {
